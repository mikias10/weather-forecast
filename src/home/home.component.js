	...
	searchByCity(name){
			...
			if(this.items){
				this.items.map(function(item){
					if(item.main.temp){
						...
						item.main.temp = item.main.temp.toFixed(2);
						item.main.temp_max = ((item.main.temp_max - 32) * 5)/9;
						item.main.temp_max = item.main.temp_max.toFixed(2);
						item.main.temp_min = ((item.main.temp_min - 32) * 5)/9;
						item.main.temp_min = item.main.temp_min.toFixed(2);
					}
				});
		...
		convertToFahrenheit(){
			if(this.items){
				this.items.map(function(item){
					if(item.main.temp){
						item.main.temp = (item.main.temp * (9/5)) + 32.0;
						item.main.temp = item.main.temp.toFixed(2);
						item.main.temp_max = (item.main.temp_max * (9/5)) + 32.0;
						item.main.temp_max = item.main.temp_max.toFixed(2);
						item.main.temp_min = (item.main.temp_min * (9/5)) + 32.0;
						item.main.temp_min = item.main.temp_min.toFixed(2);
					}
				});
				this.inFahrenheit = false;
